...
public class HouseUnitDistributionDao {
  ...
  public static HouseUnitDistributionDao getInstance() {
    if (HouseUnitDistributionDao.instance == null) {
      HouseUnitDistributionDao.instance = new HouseUnitDistributionDao();
    }
    return HouseUnitDistributionDao.instance;
  }



  // HouseHoldId SingleUnit TwoToNineUnit TenMoreUnit MobileHome
  public HouseUnitDistribution getHouseUnitDistributionByHouseHoldId(int houseHoldId)
      throws SQLException {
    String selectHouseUnitDistribution =
        "SELECT * FROM HouseUnitDistribution WHERE HouseHoldId = ?;";
