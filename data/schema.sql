...
# Load the data.
LOAD DATA LOCAL INFILE '/tmp/address.csv' INTO TABLE Address
  FIELDS TERMINATED BY ','
  LINES TERMINATED BY '\r'
  IGNORE 1 LINES;
  
LOAD DATA LOCAL INFILE '/tmp/population.csv' INTO TABLE Population
  FIELDS TERMINATED BY ','
  LINES TERMINATED BY '\r'
  IGNORE 1 LINES;
 

LOAD DATA LOCAL INFILE '/tmp/GenderDistribution.csv' INTO TABLE GenderDistribution
  FIELDS TERMINATED BY ','
  LINES TERMINATED BY '\r'
  IGNORE 1 LINES;
  
  
LOAD DATA LOCAL INFILE '/tmp/AgeDistribution.csv' INTO TABLE AgeDistribution
  FIELDS TERMINATED BY ','
  LINES TERMINATED BY '\r'
  IGNORE 1 LINES;
...
LOAD DATA LOCAL INFILE '/tmp/pop_area.csv' INTO TABLE AreaDistribution
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE '/tmp/pop_edu.csv' INTO TABLE EducationDistribution
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE '/tmp/pop_insurance.csv' INTO TABLE InsuranceDistribution
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE '/tmp/pop_diversity.csv' INTO TABLE Diversity
  FIELDS TERMINATED BY ','
  LINES TERMINATED BY '\r'
  IGNORE 1 LINES;

LOAD DATA LOCAL INFILE '/tmp/household.csv' INTO TABLE HouseHold
  FIELDS TERMINATED BY ','
  LINES TERMINATED BY '\r'
  IGNORE 1 LINES;
  
  
LOAD DATA LOCAL INFILE '/tmp/houseUnits.csv' INTO TABLE HouseUnitDistribution
  FIELDS TERMINATED BY ','
  LINES TERMINATED BY '\r'
  IGNORE 1 LINES;
  
LOAD DATA LOCAL INFILE '/tmp/houseOccpied.csv' INTO TABLE OccupiedDistribution
  FIELDS TERMINATED BY ','
  LINES TERMINATED BY '\r'
  IGNORE 1 LINES;
